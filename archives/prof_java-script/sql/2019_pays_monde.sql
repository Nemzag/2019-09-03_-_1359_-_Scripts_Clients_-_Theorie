...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 26 Janvier 2015 à 13:35
...
--
-- Base de données :  `2019_pays_monde`
--
CREATE DATABASE IF NOT EXISTS `2019_pays_monde` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `2019_pays_monde`;
...
CREATE TABLE IF NOT EXISTS `pays` (
  `idP` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `codeP` int(3) NOT NULL,
  `alpha2P` varchar(2) NOT NULL,
  `alpha3P` varchar(3) NOT NULL,
  `nomEnP` varchar(45) NOT NULL,
  `nomFrP` varchar(45) NOT NULL,
  PRIMARY KEY (`idP`),
  UNIQUE KEY `alpha2` (`alpha2P`),
  UNIQUE KEY `alpha3` (`alpha3P`),
  UNIQUE KEY `code_unique` (`codeP`)
...
INSERT INTO `pays` (`idP`, `codeP`, `alpha2P`, `alpha3P`, `nomEnP`, `nomFrP`) VALUES
